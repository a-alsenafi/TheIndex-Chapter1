        ...
        <div className="authors">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 col-12">
              <div className="card">
                <div className="image">
                  <img className="card-img-top img-fluid" src={authors[0].imageUrl} alt={authors[0].last_name}/>
                </div>
            ...
            <div className="col-lg-4 col-md-6 col-12">
              <div className="card">
                <div className="image">
                  <img className="card-img-top img-fluid" src={authors[1].imageUrl} alt={authors[1].last_name}/>
                </div>
                <div className="card-body">
                  <h5 className="card-title">
            ...
            <div className="col-lg-4 col-md-6 col-12">
              <div className="card">
                <div className="image">
                  <img className="card-img-top img-fluid" src={authors[2].imageUrl} alt={authors[2].last_name}/>
                </div>
                <div className="card-body">
                  <h5 className="card-title">
